  ...
  const ShareButtons = () => (
    <div className="grid grid-cols-5 gap-1.5 md:gap-2">
      <button
        ...
        className="p-2 md:p-2.5 bg-gradient-to-br from-zinc-800/15 via-zinc-700/15 to-zinc-800/15 backdrop-blur-xl hover:from-green-600/20 hover:via-emerald-600/20 hover:to-teal-600/20 hover:border-green-500/30 border border-zinc-600/15 rounded-lg transition-all duration-200 flex items-center justify-center group"
      ...
      <button
        ...
        className="p-2 md:p-2.5 bg-gradient-to-br from-zinc-800/15 via-zinc-700/15 to-zinc-800/15 backdrop-blur-xl hover:from-blue-600/20 hover:via-cyan-600/20 hover:to-sky-600/20 hover:border-blue-500/30 border border-zinc-600/15 rounded-lg transition-all duration-200 flex items-center justify-center group"
      ...
      <button
        ...
        className="p-2 md:p-2.5 bg-gradient-to-br from-zinc-800/15 via-zinc-700/15 to-zinc-800/15 backdrop-blur-xl hover:from-sky-600/20 hover:via-blue-600/20 hover:to-cyan-600/20 hover:border-sky-500/30 border border-zinc-600/15 rounded-lg transition-all duration-200 flex items-center justify-center group"
      ...
      <button
        ...
        className="p-2 md:p-2.5 bg-gradient-to-br from-zinc-800/15 via-zinc-700/15 to-zinc-800/15 backdrop-blur-xl hover:from-pink-600/20 hover:via-rose-600/20 hover:to-fuchsia-600/20 hover:border-pink-500/30 border border-zinc-600/15 rounded-lg transition-all duration-200 flex items-center justify-center group"
  ...
  return createPortal(
    ...
    >
      <motion.div
        ...
        className="bg-gradient-to-br from-zinc-800/15 via-zinc-700/15 to-zinc-800/15 backdrop-blur-2xl border border-zinc-600/15 rounded-lg md:rounded-xl p-4 md:p-5 max-w-sm w-full mx-3 md:mx-4 shadow-2xl relative"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Close Button */}
        <button
          onClick={onClose}
          className="absolute top-2 right-2 md:top-3 md:right-3 p-1 md:p-1.5 rounded-lg bg-zinc-800/30 hover:bg-zinc-700/40 text-white/60 hover:text-white transition-all duration-200"
