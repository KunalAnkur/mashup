...
const SourceSelection = () => {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col items-center justify-center bg-[#18181b] px-4 py-6 overflow-y-auto">
      <div className="w-full max-w-lg flex flex-col items-center gap-3 sm:gap-4 md:gap-5 lg:gap-6 my-auto">
        {/* LOGO */}
        ...
        <div className="w-full">
          ...
          <p className="text-gray-400 text-center mb-3 sm:mb-4 text-xs sm:text-sm font-medium px-4">
            Start a new session by uploading a file or using a URL.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-5 lg:gap-6 justify-center items-stretch w-full px-2">
            <input
              ref={fileInputRef}
        ...
        <div className="w-full flex flex-col items-center px-2">
          ...
          <div className="flex w-full max-w-xl gap-2 sm:gap-3">
            <input
              type="text"
              placeholder="Room ID"
              value={roomId}
